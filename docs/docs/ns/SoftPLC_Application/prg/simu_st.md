...
INTERFACE
    VAR
        clock : ClockPulse := Struct initialization unsupported; (*Clock pulse for the program*)
        i : UINT := Struct initialization unsupported; (*Iterator variable*)
        vG1PlantsAlive : UINT := Struct initialization unsupported; (*Number of plants alive in garden 1*)
        vG2PlantsAlive : UINT := Struct initialization unsupported; (*Number of plants alive in garden 2*)
        vG3PlantsAlive : UINT := Struct initialization unsupported; (*Number of plants alive in garden 3*)
        vG4PlantsAlive : UINT := Struct initialization unsupported; (*Number of plants alive in garden 4*)
        vGarden1 : ARRAY[0..24] OF derived := Struct array initialization unsupported; (*Locations of plant cells in the HMI for the garden 1. Not to be mistaken with servo offset*)
        vGarden2 : ARRAY[0..24] OF derived := Struct array initialization unsupported; (*Locations of plant cells in the HMI for the garden 2. Not to be mistaken with servo offset*)
        vGarden3 : ARRAY[0..24] OF derived := Struct array initialization unsupported; (*Locations of plant cells in the HMI for the garden 3. Not to be mistaken with servo offset*)
        vGarden4 : ARRAY[0..24] OF derived := Struct array initialization unsupported; (*Locations of plant cells in the HMI for the garden 4. Not to be mistaken with servo offset*)
        vGarden1Platform : Platform_typ := Struct initialization unsupported; (*Platform 1 properties like x,y, water valve open etc*)
        vGarden2Platform : Platform_typ := Struct initialization unsupported; (*Platform 2 properties like x,y, water valve open etc*)
        vGarden3Platform : Platform_typ := Struct initialization unsupported; (*Platform 3 properties like x,y, water valve open etc*)
        vGarden4Platform : Platform_typ := Struct initialization unsupported; (*Platform 4 properties like x,y, water valve open etc*)
    END_VAR
END_INTERFACE
PROGRAM simu:
